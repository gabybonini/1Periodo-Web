...
botao_signUp.innerText = "Criar novo usuario";
...
function cadastrarUsuario(){
    const novoUsuario = document.getElementById("idUsuario").value;
    const novaSenha = document.getElementById("idSenha").value;
    const cadastro = new usuarioCadastrado(novoUsuario, novaSenha);
    let repete = false;
    let  i = 0;
